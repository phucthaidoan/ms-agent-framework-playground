...
- **DB path**: same temp DB as Section08 (`af-course-vector-store.db`), separate collection `cv_job_profiles`
...
Use CVs from `samples/CV_Screening/PRD.md`. Recommended test cases:
